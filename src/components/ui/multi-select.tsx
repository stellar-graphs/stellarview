...
const MultiSelect: React.FC<MultiSelectProps> = ({
  ...
  }, [value, itemCache, open, onSearch, filter, disabled, maxCount, handleSelect, handleDeselect]);
...
const MultiSelectValue = React.forwardRef<React.ElementRef<typeof Primitive.div>, MultiSelectValueProps>(function MultiSelectValue(
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className={ny("flex flex-1 flex-wrap items-center gap-1.5 overflow-x-hidden", className)} {...props} ref={forwardRef}>
...
const MultiSelectList = React.forwardRef<React.ElementRef<typeof CommandList>, React.ComponentPropsWithoutRef<typeof CommandList>>(
  ({ className, ...props }, ref) => {
    return <CommandList ref={ref} className={ny("max-h-[unset] px-0 py-1", className)} {...props} />;
  }
);
...
const MultiSelectContent = React.forwardRef<React.ElementRef<typeof PopoverPrimitive.Content>, MultiSelectContentProps>(
  function MultiSelectValue({ className, children, ...props }, ref) {
    ...
    return (
      <PopoverPrimitive.Portal forceMount>
        ...
        >
          <Command
            className={ny("max-h-96 w-full min-w-[var(--radix-select-trigger-width)] px-1", className)}
...
const MultiSelectItem = React.forwardRef<React.ElementRef<typeof CommandItem>, MultiSelectItemProps>(function MultiSelectItem(
  { value, onSelect: onSelectProp, onDeselect: onDeselectProp, children, label, disabled: disabledProp, className, ...props },
  forwardedRef
) {
